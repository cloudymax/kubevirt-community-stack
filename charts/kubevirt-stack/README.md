...
![Version: 0.4.3](https://img.shields.io/badge/Version-0.4.3-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.0.0](https://img.shields.io/badge/AppVersion-0.0.0-informational?style=flat-square)
...
|------------|------|---------|
| https://cloudymax.github.io/kubevirt-community-stack | capi(cluster-api-operator) | 2.2.1 |
| https://cloudymax.github.io/kubevirt-community-stack | operator(kubevirt) | 0.7.0 |
| https://cloudymax.github.io/kubevirt-community-stack | cdi(kubevirt-cdi) | 0.5.0 |
