...
| virtualMachinePool.keda.enabled | bool | `false` | options for using Keda HPA. |
| virtualMachinePool.replicas | int | `2` | number of replicas to create. Ignored when hpa or Keda is set to 'true' |
